...
public class ChoosePay implements Interaction {
	...
	public ChoosePay(String choosePay, String safePayName, String safePayPassword, String cardNumber, String cvvNumber,
	...
	public static ChoosePay enAdvantage(String choosePay, String safePayName, String safePayPassword, String cardNumber,
			String cvvNumber, String mmExpirationDate, String yyExpirationDate, String cardHolderName) {
		return new ChoosePay(choosePay, safePayName, safePayPassword, cardNumber, cvvNumber, mmExpirationDate,
				yyExpirationDate, cardHolderName);
	}
